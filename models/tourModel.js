...
const tourSchema = new mongoose.Schema(
    {
        ...
        maxGroupSize: {
            type: Number,
            reuired: [true, 'A tour must have a group size']
        },
        difficulty: {
            type: String,
        ...
        priceDiscount: {
            ...
            validate: {
                validator: function(val) {
                    ...
                    // doesn't work on Update or Patch
                    // Only using this method because we are using this. fields
...
// Study the access points' pattern (sort, price, etc...) to decide what to index
...
//     console.log('tourModel Middleware Aggregation: ', this.pipeline());
//     next();
// });
