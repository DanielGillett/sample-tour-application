...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFuaWVsZ2lsbGV0dCIsImEiOiJjazNxOWM4ZWUwNTJvM21vOXBvcXVieWFrIn0.Gg3p8c6d1zq-iPdp5gecTQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/danielgillett/ck3qaw09l1uwv1cqi5cf59gem',
  ...
  return regeneratorRuntime.async(function logout$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          console.log('logout.js--status: ', res.data.status);
  ...
  return regeneratorRuntime.async(function updateSettings$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated sucessfully!"));
          _context.next = 11;
          break;
...
/* eslint-disable */
var stripe = Stripe('pk_test_pNWFYCXOhbLdtLRet5iZtSX1');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    }, 'password'); // document.querySelector('.btn--save-password').textContent = 'Save password';
